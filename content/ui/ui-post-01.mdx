...
This component combines **[ShadCNUI](https://ui.shadcn.com)'s** `Dialog` and `Drawer` component to create a responsive modal that renders a `Dialog` on desktop and a `Drawer` on mobile.
